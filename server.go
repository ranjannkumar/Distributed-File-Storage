...
func (s *FileServer)Get(key string)(io.Reader,error){
	...
	fmt.Printf("[%s] dont have file (%s) loacally, fetching from network...\n",s.Transport.Addr(),key)
	...
	for _,peer := range s.peers{
		...
		fmt.Printf("[%s] received (%d) bytes over the network (%s)",s.Transport.Addr(),n,peer.RemoteAddr())
...
//This function handles incoming messages from peers and processes them.
